		...
		<li> <a class="totalInCart" href="cart.html"><strong>Total Amount  <span class="badge badge-warning pull-right" style="line-height:18px;"></span></strong></a></li>
			...
			<li>
			  <div class="thumbnail">
				...
				<div class="caption">
				  <h4><a class="defaultBtn" href="product_details.html"></a> <span class="pull-right">$1.00</span></h4>
				</div>
			  </div>
			</li>
			<li style="border:0"> &nbsp;</li>
			<li>
			  <div class="thumbnail">
				...
				<div class="caption">
				  <h4><a class="defaultBtn" href="product_details.html"></a> <span class="pull-right">$10.00</span></h4>
				</div>
			  </div>
			</li>
			<li style="border:0"> &nbsp;</li>
...
<form method='POST'>
<table  height='900' width='600'border='1'
 style='box-shadow:20px 60px 60px grey' 
 align='center'>
<tr>
	<td height='100' colspan='2'><h4>Contact Us..!</h4>
	</td>
</tr>
<tr>
	<td colspan='2'><h4>Contact Us..!</h4>
	</td>
